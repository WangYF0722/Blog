...
public class IndexController {
    ...
    public String index(@RequestParam(required = false,defaultValue = "1")Integer pageIndex,
        ...
        model.addAttribute("pageUserPrefix","/article?pageIndex");
        return "Home/index";
